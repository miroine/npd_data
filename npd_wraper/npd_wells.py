...
class well_data(npd):
    ...
    def get_current_exploration_wells(self):

        '''
        return wells with thin section
        '''
        url_dataset = self._get_total_path(tag_name="wellbore_exploration_current_year")
        return self._get_dataframe_data(url_dataset)
    
    def get_last_year_exploration_wells(self):

        '''
        return wells with thin section
        '''
        url_dataset = self._get_total_path(tag_name="wellbore_exploration_last_year")
        return self._get_dataframe_data(url_dataset)